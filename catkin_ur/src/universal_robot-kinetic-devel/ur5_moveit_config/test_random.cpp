...
//   class to deal directly with the world.
  ...
  target_pose1.position.x = 0.618;
  target_pose1.position.y = 0.0936;
  target_pose1.position.z = 0.368;
...
//  bool is_success=group.plan(my_plan);

//  ROS_INFO("Visualizing plan 1 (pose goal) %s",is_success?"":"FAILED");
