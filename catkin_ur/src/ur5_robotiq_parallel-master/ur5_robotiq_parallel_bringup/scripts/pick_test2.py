...
if __name__=='__main__':
    ...
    p1.pose.position.y = 0.7
    p1.pose.position.z = 0.1-0.025-0.105
    scene.add_box("floor", p1, (0.2,0.4,0.01))
    p2 = PoseStamped()
    p2.header.frame_id = robot.get_planning_frame()
    p2.pose.position.x = -0.6
    p2.pose.position.y = 0.7+0.195
    p2.pose.position.z = 0.1-0.025
    scene.add_box("wall1", p2, (0.04,0.04,0.2))
    p3 = PoseStamped()
